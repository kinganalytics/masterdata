...
namespace AzureMLRRSWebTemplate
{
    public partial class Setting : System.Web.UI.Page
    {
        ...
        private void GenarateInformation()
        {
            ...
            parameterRegion.Controls.Add(new LiteralControl("<tr><td style=\"width:15%\">Service Name</td>"));
            ...
            parameterRegion.Controls.Add(new LiteralControl("<tr><td style=\"width:15%\">Service Description</td>"));
            parameterRegion.Controls.Add(new LiteralControl(string.Format("<td>")));
