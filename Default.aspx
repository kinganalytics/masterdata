...
<body onresize="updateResize()">
    <div class="container azue-header">
        <div class="jumbotron azue-header" style="background-image: url('Resources/azure-ml.png'); height: 100px; position: relative; padding-top: 5px;">
            <a href="/">
                <div class="wheel">
                    <wheel></wheel>
                </div>
            ...
            <div style="max-height: 110px; overflow-y: hidden">
                <h3 class="text-muted" style="padding-left: 100px; padding-right: 5px;">
